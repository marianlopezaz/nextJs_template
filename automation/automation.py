...
def generate(name):
    ...
    service_file_path = base_path + '/utils/' + name + '/services/' + name + '_services.js'

    #genero ruta para guardar el servicio
    service_path = base_path + '/utils/' + name + '/services/'
    ...
    crud_file_path = base_path + '/utils/' + name + '/cruds/' + name + '_cruds.js'

    #genero ruta para guardar el crud
    cruds_path = base_path + '/utils/' + name + '/cruds/'
